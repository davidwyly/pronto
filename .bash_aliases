...
alias attach_php='docker exec -it -e TERM=xterm-256 mb_php_1 bash -c "cd /var/www/pronto && /bin/bash"'
alias attach_nginx='docker exec -it -e TERM=xterm-256 mb_nginx_1 bash -c "cd /var/www/pronto && /bin/bash"'
